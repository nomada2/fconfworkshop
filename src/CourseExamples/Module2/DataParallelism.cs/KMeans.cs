...
namespace DataParallelism.CSharp
{
    public class KMeans
    {
        ...
        //  Function to find the closest centroid(used to update the clusters)
        ...
        //  Update the location of the centroids according to the center of the cluster
        ...
        //  UpdateCentroids function implemented without Aggregate
